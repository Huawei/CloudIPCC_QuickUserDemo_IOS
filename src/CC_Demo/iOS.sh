...
#plist文件所在路径
exportOptionsPlistPath=${project_path}/CCDemo/Info.plist
#导出文件所在路径
exportFilePath=${project_path}/build
...
-scheme ${scheme_name} \
-archivePath ${exportFilePath}/${project_name}.xcarchive || exit

# 打包
xcodebuild -exportArchive -archivePath ${exportFilePath}/${project_name}.xcarchive \
